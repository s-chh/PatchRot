...
class PRotLoader(datasets.SVHN):
	def __init__(self, args, root, split='train', transform=None, target_transform=None, download=False):
	...
	def __getitem__(self, index):
		...
		img_ = F.normalize(img_, self.args.mean, self.args.std)
		imgs.append(img_)
